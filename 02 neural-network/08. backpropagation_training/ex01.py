...
network.initialize(input_size = train_x.shape[1], hidden_size = [50, 20, 5], output_size = train_t.shape[1])
...
#
#
# for idx in range(1, ierations+1):
#     print(f'start')
...
#
#
#     print(f'#{idx+1} : loss :{loss}, elapsed time : {elapsed:.3f}s')
